" neomoonfly color scheme for lightline (github.com/itchyny/lightline.vim).
"
...
if exists('g:lightline')
    ...
    let g:lightline#colorscheme#neomoonfly#palette = lightline#colorscheme#flatten(s:p)
endif
