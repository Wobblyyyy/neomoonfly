...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#323437', '#ff5454', '#8cc85f', '#e3c78a', '#80a0ff', '#d183e8', '#79dac8', '#c6c6c6', '#949494', '#ff5189', '#36c692', '#c2c292', '#74b2ff', '#ae81ff', '#85dc85', '#e4e4e4']"
...
gset string palette "#323437:#ff5454:#8cc85f:#e3c78a:#80a0ff:#d183e8:#79dac8:#c6c6c6:#949494:#ff5189:#36c692:#c2c292:#74b2ff:#ae81ff:#85dc85:#e4e4e4"
